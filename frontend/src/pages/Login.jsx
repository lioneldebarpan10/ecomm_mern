...
const Login = () => {
  ...
  return (
    <form className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800' onSubmit={onSubmitHandler}>
      ...
      <input type="email" className='w-full px-3 py-2 border border-gray-800' placeholder='Enter Email' required/>
      ...
      <div className='w-full flex justify-between text-sm mt-[-8px]'>
        ...
        {
          currentState === 'Login' ? <p className='cursor-pointer' onClick={() => setCurrentState('Signup')}>Create Account</p> 
